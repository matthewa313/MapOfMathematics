...
with open("latex/template_node.tex", 'r') as file:
    default_template = file.read()

with open("latex/preamble.tex", 'r') as file:
    default_preamble = file.read()
...
def latex2svg(code, params=default_params, color="white", working_directory=None):
    ...
    if working_directory is None:
        with TemporaryDirectory() as tmpdir:
            return latex2svg(code, params, color=color, working_directory=tmpdir)
...
def main():
    ...
    try:
        ...
        out = latex2svg(latex, params, "white")
